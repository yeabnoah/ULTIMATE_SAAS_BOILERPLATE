			...
			<div className="container relative z-10 mx-auto px-4 md:px-6">
				<div className="mx-auto max-w-3xl text-center">
					...
					<motion.div
						...
						animate="visible"
					>
						<h1 className="mb-6 font-bold text-2xl tracking-tight sm:text-4xl md:mb-8 md:text-6xl">
					...
					<motion.div
						...
						animate="visible"
					>
						<p className="mx-auto mb-8 max-w-xl px-4 font-light text-sm text-white/40 leading-relaxed tracking-wide sm:text-base md:text-lg">
							A modern, production-ready boilerplate to kickstart your SaaS
							product,built with best practices, authentication, billing, and
							dashboard all set up.
						</p>
					</motion.div>
				</div>
			</div>
